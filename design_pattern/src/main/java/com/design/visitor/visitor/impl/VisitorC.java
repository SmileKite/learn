 ...
 * @date 2021/7/15
 */
public class VisitorC implements IVisitor {
    @Override
    public void visit(VisitableA visitable) {
        System.out.println("访问者C访问被访问者A，执行相关逻辑");
    }

    @Override
    public void visit(VisitableB visitable) {
        System.out.println("访问者C访问被访问者B，执行相关逻辑");
    }

    @Override
    public void visit(VisitableC visitable) {
        System.out.println("访问者C访问被访问者C，执行相关逻辑");
    }
}
